...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 24 20:09:54 2021

@author: dileepn
"""

#%% Adiabatic flame temperature of a hydrogen flame with complete and incomplete combustion 
...
for i in range(len(phi)):
    ...
    gas1.set_equivalence_ratio(phi[i], 'H2', 'O2:1, N2:3.76')
    gas1.equilibrate('HP')
    T_complete[i] = gas1.T 
